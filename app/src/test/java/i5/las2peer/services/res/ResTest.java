...
assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(everyItem(isA(JSONObject.class)))));assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(hasItem(isA(JSONObject.class)))));assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(everyItem(isA(String.class)))));
