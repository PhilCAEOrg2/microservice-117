...
/**
 * Service29 - Test Class
 *
 * This class provides a basic testing framework for the microservice Service29. It was
...
assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(everyItem(isA(JSONObject.class)))));assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(everyItem(isA(String.class)))));assertThat(response, both(isA(JSONArray.class)).and(asJSONObjectList(hasItem(isA(JSONObject.class)))));
      Assert.assertEquals("Status code equals 200 [279409]", result.getHttpCode(), 200);
